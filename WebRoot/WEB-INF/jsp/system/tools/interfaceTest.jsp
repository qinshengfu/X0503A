								...
								<div class="widget-body">
								 <div class="widget-main">
										...
										<textarea id="json-field" title="返回结果" class="autosize-transition span12" style="width:690px;"></textarea>
									 	...
									 	<div class="step-content row-fluid position-relative">
										<label style="float:left;padding-left: 35px;">服务器响应：<font color="redEnvelope" id="stime">-</font>&nbsp;毫秒</label>
										<label style="float:left;padding-left: 35px;">客户端请求：<font color="redEnvelope" id="ctime">-</font>&nbsp;毫秒</label>
										</div>
										<br/>
										<div class="step-content row-fluid position-relative">
