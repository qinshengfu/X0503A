						        	...
						        	<table>
						        		...
						        		<tr>
						        			<td style="padding-left: 16px;" colspan="100">
						        				<font color="redEnvelope" style="font-weight: bold;">
						        					注意：<br/>
					...
					<form action="createCode/proCode.do" name="Form" id="Form" method="post">
						...
						<table style="margin-top: 5px;">
							<tr>
								...
								<td>&nbsp;&nbsp;例如:com.fh.controller.<font color="redEnvelope" style="font-weight: bold;">system</font>&nbsp;&nbsp;只输入红色部分</td>
						...
						<table style="margin-top: 5px;">
							<tr>
								...
								<td>&nbsp;&nbsp;<font color="redEnvelope" style="font-weight: bold;">类名首字母必须为大写字母或下划线</font></td>
