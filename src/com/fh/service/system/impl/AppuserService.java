...
public class AppuserService implements AppuserManager{
	 ...
	 */
	@Override
	public PageData getAppDayUserCount(String value) throws Exception {
		return (PageData)dao.findForObject("AppuserMapper.getAppDayUserCount", value);
	}
	/**累积排单金额统计
	 * @throws Exception
	 */
	@Override
	public PageData getBuyCount(String value) throws Exception {
		return (PageData)dao.findForObject("AppuserMapper.getBuyCount", value);
	}
	/**今日排单金额统计
	 * @throws Exception
	 */
	@Override
	public PageData getDayBuyCount(String value) throws Exception {
		return (PageData)dao.findForObject("AppuserMapper.getDayBuyCount", value);
	}
	/**累积提现金额统计
	 * @throws Exception
	 */
	@Override
	public PageData getSellCount(String value) throws Exception {
		return (PageData)dao.findForObject("AppuserMapper.getSellCount", value);
	}
	/**今日提现金额统计
	 * @throws Exception
	 */
	@Override
	public PageData getDaySellCount(String value) throws Exception {
		return (PageData)dao.findForObject("AppuserMapper.getDaySellCount", value);
	}
	/**累积匹配金额统计
	 * @throws Exception
	 */
	@Override
	public PageData getMatchCount(String value) throws Exception {
		return (PageData)dao.findForObject("AppuserMapper.getMatchCount", value);
	}
	/**今日匹配金额统计
	 * @throws Exception
	 */
	@Override
	public PageData getDayMatchCount(String value) throws Exception {
		return (PageData)dao.findForObject("AppuserMapper.getDayMatchCount", value);
	}
