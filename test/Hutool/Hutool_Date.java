...
/**
 * 说明：Hutool是一个小而全的Java工具类库，通过静态方法封装，下面展示日期的常用方法
 * 创建人：Ajie
 * 创建时间：2020-3-3 10:58:24
 */
public class Hutool_Date {
...
//        printDefaultFormat();
    ...
    public void test2() {
        ...
        //常用格式的格式化，结果：2020-03-03
        String formatDate = DateUtil.formatDate(d);

        //结果：2020-03-03 11:58:15
    ...
    public void test3() {
        ...
        p1("数字金额", a, "中文大写", digitUppercase);
        c("转换为大写只能精确到分（小数点儿后两位），之后的数字会被忽略。");
    }
    ...
    public void test4() {
        ...
        p2("当前日期",DateUtil.formatDateTime(d), "月份",month + 1);
    ...
    public void test5() {
        ...
        //一天的开始，结果：2020-03-03 00:00:00
        Date beginOfDay = DateUtil.beginOfDay(date);

        //一天的结束，结果：2020-03-03 23:59:59
    ...
    public void test10() {
        ...
        forloop(loopcount);
        long interval3 = timer.intervalMinute();

        p3("性能统计，总共花费了 (毫秒数)",interval1);
        p3("性能统计，总共花费了 (毫秒数),并重置开始时间",interval2);
        p3("性能统计，总共花费了 (分钟数)",interval3);
    }
