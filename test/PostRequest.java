...
public class PostRequest {
    ...
    public static final String GET_URL = "http://localhost:80/b9810/release/emailCode";

    public static final String POST_URL = "http://localhost:80/b9810/release/emailCode";
